...
#gives user to do anything with their profile and gives readonly status to other user profile
...
class LoginViewSet(viewsets.ViewSet):
    """ check email, password and returns a auth token """
...
class UserProfileFeedViewSet(viewsets.ModelViewSet):
    """ Handles creating, reading, updating the profile feed items  """
    serializer_class = serializers.ProfileFeedItemSerializer
    authentication_classes = (TokenAuthentication, )## meant to be toople object
